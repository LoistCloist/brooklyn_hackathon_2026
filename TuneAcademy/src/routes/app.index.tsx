            ...
            <>
              ...
              >
                <div className="flex min-h-40 flex-col rounded-lg border border-[#fffdf5]/15 bg-[#fffdf5]/8 p-5">
                  ...
                  <p className="mt-auto text-5xl font-black leading-none text-[#fffdf5] tabular-nums">
                ...
                <div className="flex min-h-40 flex-col rounded-lg border border-[#fffdf5]/15 bg-[#fffdf5]/8 p-5">
                  ...
                  {latestReviewStars != null ? (
                    ...
                    <p className="mt-auto text-lg font-bold leading-snug text-[#e8f4df]/50">
                      No ratings yet
                    </p>
                  )}
                </div>
                        ...
                        <li key={row.learnerId}>
                          ...
                          >
                            ...
                            <span className="shrink-0 text-sm font-semibold tabular-nums text-[#e8f4df]/70">
                              ...
                              {row.completedSessions === 1 ? "session" : "sessions"}
                            </span>
                          </Link>
                        </li>
                      );
