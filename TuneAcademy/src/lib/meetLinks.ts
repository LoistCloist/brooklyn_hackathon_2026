/**
 * Demo Google Meet-style links. Production creates Google Calendar events with
 * Meet conference data from Cloud Functions, then stores the returned `meetingUri`.
 */
